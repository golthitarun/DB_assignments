...
CREATE BITMAP INDEX MAJESTIC_TLD ON MAJESTIC_INDEX1(TLD);
...
create bitmap index MAJESTIC_RefSubNets on MAJESTIC_INDEX2(RefSubNets);
...
create bitmap index TLD_RefIPs on MAJESTIC_INDEX3(TLD,RefIPs);
